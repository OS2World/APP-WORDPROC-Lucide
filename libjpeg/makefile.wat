...
CFLAGS=-zq -zp=4 -bm -ox -bt=$(SYSTEM)
...
all: libjpeg.lib cjpeg.exe djpeg.exe jpegtran.exe rdjpgcom.exe wrjpgcom.exe example.exe

libjpeg.lib: $(LIBOBJECTS)
    - del libjpeg.lib
    * wlib -b -q libjpeg.lib + $(CLIBOBJECTS)
    * wlib -b -q libjpeg.lib + $(DLIBOBJECTS)
    * wlib -b -q libjpeg.lib + $(COMOBJECTS)
