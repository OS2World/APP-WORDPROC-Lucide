...
ddjvu_context_t * DDJVUAPI ddjvu_context_create(const char *programname);
...
void DDJVUAPI ddjvu_context_release(ddjvu_context_t *context);
...
void DDJVUAPI ddjvu_cache_set_size(ddjvu_context_t *context,
...
unsigned long DDJVUAPI ddjvu_cache_get_size(ddjvu_context_t *context);


/* ddjvu_cache_clear ---
   Clears all cached data. */

void DDJVUAPI ddjvu_cache_clear(ddjvu_context_t *context);
...
ddjvu_message_t * DDJVUAPI ddjvu_message_peek(ddjvu_context_t *context);
...
ddjvu_message_t * DDJVUAPI ddjvu_message_wait(ddjvu_context_t *context);
...
void DDJVUAPI ddjvu_message_pop(ddjvu_context_t *context);
...
void DDJVUAPI ddjvu_message_set_callback(ddjvu_context_t *context,
...
ddjvu_status_t DDJVUAPI ddjvu_job_status(ddjvu_job_t *job);
...
void DDJVUAPI ddjvu_job_stop(ddjvu_job_t *job);
...
void DDJVUAPI ddjvu_job_set_user_data(ddjvu_job_t *job, void *userdata);

void * DDJVUAPI ddjvu_job_get_user_data(ddjvu_job_t *job);
...
void DDJVUAPI ddjvu_job_release(ddjvu_job_t *job);
...
ddjvu_document_t * DDJVUAPI ddjvu_document_create(ddjvu_context_t *context,
                      const char *url,
                      int cache);
...
ddjvu_document_t * DDJVUAPI ddjvu_document_create_by_filename(ddjvu_context_t *context,
                                  const char *filename,
                                  int cache);
...
ddjvu_job_t * DDJVUAPI ddjvu_document_job(ddjvu_document_t *document);
...
void DDJVUAPI ddjvu_stream_write(ddjvu_document_t *document,
                   int streamid,
                   const char *data,
...
void DDJVUAPI ddjvu_stream_close(ddjvu_document_t *document,
                   int streamid,
                   int stop );
...
ddjvu_document_type_t DDJVUAPI ddjvu_document_get_type(ddjvu_document_t *document);
...
int DDJVUAPI ddjvu_document_get_pagenum(ddjvu_document_t *document);
...
ddjvu_status_t DDJVUAPI ddjvu_document_get_pageinfo(ddjvu_document_t *document, int pageno, 
                            ddjvu_pageinfo_t *info);
...
ddjvu_page_t * DDJVUAPI ddjvu_page_create_by_pageno(ddjvu_document_t *document,
                            int pageno);
...
ddjvu_page_t * DDJVUAPI ddjvu_page_create_by_pageid(ddjvu_document_t *document,
                            const char *pageid);
...
ddjvu_job_t * DDJVUAPI ddjvu_page_job(ddjvu_page_t *page);
...
int DDJVUAPI ddjvu_page_get_width(ddjvu_page_t *page);
...
int DDJVUAPI ddjvu_page_get_height(ddjvu_page_t *page);
...
int DDJVUAPI ddjvu_page_get_resolution(ddjvu_page_t *page);
...
double DDJVUAPI ddjvu_page_get_gamma(ddjvu_page_t *page);
...
int DDJVUAPI ddjvu_page_get_version(ddjvu_page_t *page);
...
ddjvu_page_type_t DDJVUAPI ddjvu_page_get_type(ddjvu_page_t *page);
...
char * DDJVUAPI ddjvu_page_get_short_description(ddjvu_page_t *page);

char * DDJVUAPI ddjvu_page_get_long_description(ddjvu_page_t *page);
...
ddjvu_page_rotation_t DDJVUAPI ddjvu_page_get_rotation(ddjvu_page_t *page);
...
void DDJVUAPI ddjvu_page_set_rotation(ddjvu_page_t *page,
...
int DDJVUAPI ddjvu_page_render(ddjvu_page_t *page,
...
ddjvu_format_t * DDJVUAPI ddjvu_format_create(ddjvu_format_style_t style, 
...
void DDJVUAPI ddjvu_format_set_row_order(ddjvu_format_t *format, int top_to_bottom);
...
void DDJVUAPI ddjvu_format_set_y_direction(ddjvu_format_t *format, int top_to_bottom);
...
void DDJVUAPI ddjvu_format_set_ditherbits(ddjvu_format_t *format, int bits);
...
void DDJVUAPI ddjvu_format_set_gamma(ddjvu_format_t *format, double gamma);
...
void DDJVUAPI ddjvu_format_release(ddjvu_format_t *format);
...
ddjvu_status_t DDJVUAPI ddjvu_thumbnail_status(ddjvu_document_t *document, int pagenum, int start);
...
int DDJVUAPI ddjvu_thumbnail_render(ddjvu_document_t *document, int pagenum, 
                       int *wptr, int *hptr,
                       const ddjvu_format_t *pixelformat,
                       unsigned long rowsize,
                       char *imagebuffer);
...
ddjvu_job_t * DDJVUAPI ddjvu_document_print(ddjvu_document_t *document, FILE *output,
...
*/
ddjvu_job_t * DDJVUAPI ddjvu_document_save(ddjvu_document_t *document, FILE *output, 
                    int optc, const char * const * optv);
...
void DDJVUAPI ddjvu_miniexp_release(ddjvu_document_t *document, miniexp_t expr);
...
miniexp_t DDJVUAPI ddjvu_document_get_outline(ddjvu_document_t *document);
...
miniexp_t DDJVUAPI ddjvu_document_get_pagetext(ddjvu_document_t *document, int pageno, 
...
miniexp_t DDJVUAPI ddjvu_document_get_pageanno(ddjvu_document_t *document, int pageno);
...
const char * DDJVUAPI ddjvu_anno_get_bgcolor(miniexp_t annotations);
...
const char * DDJVUAPI ddjvu_anno_get_zoom(miniexp_t annotations);
...
const char * DDJVUAPI ddjvu_anno_get_mode(miniexp_t annotations);
...
const char * DDJVUAPI ddjvu_anno_get_horizalign(miniexp_t annotations);
...
const char * DDJVUAPI ddjvu_anno_get_vertalign(miniexp_t annotations);
...
miniexp_t * DDJVUAPI ddjvu_anno_get_hyperlinks(miniexp_t annotations);
...
miniexp_t * DDJVUAPI ddjvu_anno_get_metadata_keys(miniexp_t annotations);
...
const char * DDJVUAPI ddjvu_anno_get_metadata(miniexp_t annotations, miniexp_t key);
...
#  ifdef _DJVUIMAGE_H
GP<DjVuImage> DDJVUAPI ddjvu_get_DjVuImage(ddjvu_page_t *page);
#  endif
#  ifdef _DJVUDOCUMENT_H
GP<DjVuDocument> DDJVUAPI ddjvu_get_DjVuDocument(ddjvu_document_t *document);
#  endif
# endif
#endif
