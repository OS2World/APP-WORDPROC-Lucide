...
//C- +------------------------------------------------------------------
// 
// $Id: DjVuMessage.cpp,v 1.19 2007/03/25 20:48:30 leonb Exp $
// $Name: release_3_5_19 $
...
#ifdef AUTOCONF
// !!! ER !!! static const char DjVuDataDir[] = DIR_DATADIR "/djvu/osi";
...
#endif
#if defined(AUTOCONF)
    // ER !!! GURL dpath = GURL::Filename::UTF8(DjVuDataDir);
