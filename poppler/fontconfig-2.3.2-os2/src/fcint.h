...
#ifdef __OS2__
// Don't print anything on OS/2
// You may ask: why?
// Well, I compile FontConfig into a DLL and when that DLL is loaded
// and unloaded multiple times into a process, it leaked process memory.
// Removing the printf()'s cured it, so, well, here is a dirty hack to
// remove all FontConfig printf()'s.
#define setbuf(...)
#define printf(...)
#endif
...
void
FcObjectStaticNameListInit();

void
FcObjectStaticNameListFini();
